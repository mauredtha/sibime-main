...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      ...
      <li><a href="{{ route('workbooks.index') }}"><em class="fa fa-bar-chart">&nbsp;</em> Buku Kerja</a></li>
			...
			<li class="active"><a href="{{ route('users.edit', Auth::user()->id) }}"><em class="fa fa-bar-chart">&nbsp;</em> Change Password</a></li>
			<li><a href="{{ route('logout') }}"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
			@else
			<li><a href="{{ route('home') }}"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
      ...
      <li><a href="{{ route('absensi') }}"><em class="fa fa-bar-chart">&nbsp;</em> Absensi</a></li>
			<li class="active"><a href="{{ route('users.edit', Auth::user()->id) }}"><em class="fa fa-dashboard">&nbsp;</em> Change Password</a></li>
			<li><a href="{{ route('logout') }}"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
			@endif
		</ul>
	</div><!--/.sidebar-->
